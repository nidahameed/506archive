...
for dinosaur in dinosaur_names:
    if dinosaur.lower().startswith('t'): #rendering it all lowercase and then checking if it starts with 't'
...
for dinosaur in dinosaurs[7:]:
    cretaceous_dinosaurs.append(dinosaur)
# TODO IMPLEMENT FOR LOOP W/SLICE
...
# logical operator (names that begin with C or D)
dinosaur_names_cd = []
for dinosaur in dinosaurs:
